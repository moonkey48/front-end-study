...
export const createPromiseThunk = (type, promiseCreator) => {
  ...
  export const createPromiseThunkById = (
    ...
    promiseCreator,
    /**
     * 파라미터에서 id를 어떻게 선택해야 하는지 정의하는 함수
     * 기본 값으로는 파라미터를 그대로 id로 사용한다.
     * 만약 파라미터가 {id:1, details:true} 이런 형태면
     * idSelector 를 param=>pram.id 이런식으로 확장이 가능하다. //goot ux for developer
     */
  ...
  export const handleAsyncActionById = (
    type,
    key,
    keepData=false
  )=>{
